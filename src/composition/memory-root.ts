...
import { InMemoryEcoRepository } from '../infrastructure/persistence/in-memory-eco.repository.js';

export type MemoryEcoRoot = ReturnType<typeof createMemoryEcoRoot>;

export function createMemoryEcoRoot(): {
  readonly store: InMemoryEcoRepository;
